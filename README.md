...
TFacts is the redesigned frontend for the `project-iii` Django blog backend. It is a responsive community publishing experience built with React and Vinext/Next-compatible routing.
...
```env
NEXT_PUBLIC_API_URL=http://127.0.0.1:9009/api
